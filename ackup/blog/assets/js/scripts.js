(function($) {
    ...
    $(window).on("load", function() {
        setTwoColEqHeight($(".post-area .post-img,.booking-img,.featured-post-wrap .featured-post-img,.about-images"), $(".post-area .post-home,.booking-form,.featured-post-wrap .featured-post-home,.about-text"));
