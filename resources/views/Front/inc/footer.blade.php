...
<div class="instagram-area mb-80">
    <div class="instagram-wrap">
        <a href="#"><img src="{{ asset('/front') }}/images/instragram/1.jpg" alt=""></a>
    </div>
    <div class="instagram-wrap">
        <a href="#"><img src="{{ asset('/front') }}/images/instragram/2.jpg" alt=""></a>
    </div>
    <div class="instagram-wrap">
        <a href="#"><img src="{{ asset('/front') }}/images/instragram/3.jpg" alt=""></a>
    </div>
    <div class="instagram-wrap">
        <a href="#"><img src="{{ asset('/front') }}/images/instragram/4.jpg" alt=""></a>
    </div>
    <div class="instagram-wrap">
        <a href="#"><img src="{{ asset('/front') }}/images/instragram/5.jpg" alt=""></a>
    </div>
    <div class="instagram-wrap">
        <a href="#"><img src="{{ asset('/front') }}/images/instragram/2.jpg" alt=""></a>
    </div>
                        ...
                        <ul>
                            <li>
                                <div class="widget_recent_entries-img">
                                    <img src="{{ asset('/front') }}/images/footer/1.jpg" alt="">
                                </div>
                            ...
                            <li>
                                <div class="widget_recent_entries-img">
                                    <img src="{{ asset('/front') }}/images/footer/2.jpg" alt="">
                                </div>
                                <div class="widget_recent_entries-content">
                ...
                <div class="col-md-6 col-lg-4 col-12">
                    <div class="footer-widget widget_recent_entries">
                        <ul>
                            <li>
                                <div class="widget_recent_entries-img">
                                    <img src="{{ asset('/front') }}/images/footer/3.jpg" alt="">
                                </div>
                                <div class="widget_recent_entries-content">
